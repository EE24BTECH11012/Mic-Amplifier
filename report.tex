...
From the diagram it can be seen that the output swing is 90 mV. Hence the output power is $\frac{0.09 * 0.09}{2 \times 8} \approx 0.5 mW $
...
The video demonstration of the project and the files related to the project can be found on the following github page \\ \href{}{}
